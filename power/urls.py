...
urlpatterns = patterns('',
    ...
    url(r'^port/(?P<tag>[a-z0-9-]+)/mode/(?P<mode>on|off)$', 'powercontrol.views.set_port_mode', name='port'),
    ...
    url(r'^set/(?P<tag>[a-z0-9-]+)/mode/(?P<mode>on|off)$', 'powercontrol.views.set_set_mode', name='set'),
